...
int main () {
    ...
    std:: ofstream file("PATRICIA_RESULTS.txt");
    ...
    file << "Insertion time in PATRICIA: " << InsertionTime << " ms" << "\n";
    file << "Searching time in PATRICIA: " << SearchingTime << " ms" << "\n";
    file << "Erasing time in PATRICIA: " << ErasingTime << " ms" << "\n";
    delete patricia;
    return 0;
}