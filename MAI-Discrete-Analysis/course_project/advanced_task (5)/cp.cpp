//Реализован полустатический алгоритм Хаффмана. Оценка - 4, так как делал впритык к экзамену и не сделал несколько флагов (рекурсивный и т.д.) - с ними было бы 5)
